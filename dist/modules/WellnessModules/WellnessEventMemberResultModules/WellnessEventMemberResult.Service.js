        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            data.forEach((el) => __awaiter(this, void 0, void 0, function* () {
                ...
                if ((loop == 0 && level == el.level) || (loop != 0 && el.parent_id == parent && el.main_id != parent)) {
                    ...
                    arr.children = yield this.convertToTree(data, el.main_id, newLevel, 1);
                    resultNew.push(arr);
                }
            }));
            return resultNew;
...
ModulesService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(WellnessEventMemberResult_Entity_1.default)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], ModulesService);
exports.default = ModulesService;
//# sourceMappingURL=WellnessEventMemberResult.Service.js.map