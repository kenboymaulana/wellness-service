    ...
    convertToTree(data, parent = null, level = 0, loop = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            data.forEach((el) => __awaiter(this, void 0, void 0, function* () {
                const arr = el;
                if ((loop == 0 && el.level == level) || (loop != 0 && el.parent_id == parent && el.id != parent)) {
...
ModulesService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(WellnessProgramItem_Entity_1.default)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], ModulesService);
exports.default = ModulesService;
//# sourceMappingURL=WellnessProgramItem.Service.js.map